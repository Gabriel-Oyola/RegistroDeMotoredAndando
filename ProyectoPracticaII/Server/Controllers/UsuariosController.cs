...
namespace ProyectoPracticaII.Server.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(Motored01Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Usuarios != null ? 
                          ...
                          Problem("Entity set 'Motored01Context.Usuarios'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Motored01Context.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
